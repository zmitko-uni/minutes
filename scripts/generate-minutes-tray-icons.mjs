...
const PREFIX = 'minutes-tray-icon';
...
async function renderBaseTrayIcon(image, size) {
  ...
  applyRoundedSquareAlphaMask(context, size, MINUTES_ICON_CORNER_RADIUS_RATIO);
...
async function main() {
  ...
  console.log(`minutes tray icons generated in ${trayIconsDir}`);
}
