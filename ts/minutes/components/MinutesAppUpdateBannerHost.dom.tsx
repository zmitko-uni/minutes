...
function AppUpdateBanner({
  ...
  if (state.kind === 'downloading') {
    ...
    return (
      <div className="MinutesAppUpdateBanner MinutesAppUpdateBanner--downloading">
        <span className="MinutesAppUpdateBanner__text">
  ...
  if (state.kind === 'ready') {
    ...
    return (
      <div className="MinutesAppUpdateBanner MinutesAppUpdateBanner--ready">
        <span className="MinutesAppUpdateBanner__text">
...
export function MinutesAppUpdateBannerHost(): JSX.Element | null {
