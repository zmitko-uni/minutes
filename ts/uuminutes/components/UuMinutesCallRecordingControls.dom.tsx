...
export function UuMinutesCallRecordingControls({
  conversationId,
  callMode,
  onMouseEnter,
  onMouseLeave,
}: PropsType): JSX.Element | null {
  const [state, setState] = useState<UuMinutesRecordingState>(
  ...
  useEffect(() => {
    const handler = (next: UuMinutesRecordingState) => setState(next);
  ...
  if (state.status === 'idle') {
    ...
    return (
      <MinutesCallControlButton
        className="UuMinutesCallRecordingControls__button UuMinutesCallRecordingControls__button--record"
        label={recordLabel}
        onClick={start}
        onMouseEnter={onMouseEnter}
        onMouseLeave={onMouseLeave}
  ...
  return (
    <>
      {state.status === 'recording' ? (
        <MinutesCallControlButton
          className="UuMinutesCallRecordingControls__button UuMinutesCallRecordingControls__button--pause UuMinutesCallRecordingControls__button--active"
        ...
        <MinutesCallControlButton
          className="UuMinutesCallRecordingControls__button UuMinutesCallRecordingControls__button--resume UuMinutesCallRecordingControls__button--active"
      ...
      <MinutesCallControlButton
        className="UuMinutesCallRecordingControls__button UuMinutesCallRecordingControls__button--stop UuMinutesCallRecordingControls__button--active"
