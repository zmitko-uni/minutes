...
import { UuMinutesLocalLlmPanel } from './UuMinutesLocalLlmPanel.dom.tsx';
...
export function UuMinutesSettingsModal({
  ...
  const languageHint = useMemo(
    () => getAiOutputLanguageLabel(outputLanguage),
    [outputLanguage]
  );
        ...
        <AxoDialog.Body>
          ...
          <div className={tw('flex flex-col gap-5')}>
            ...
            <p className={tw('-mt-2 text-label-small opacity-70')}>
              ...
              (např. „jak se máš“ místo nesmyslných slov). Použije stejného
            ...
            >
              ...
              <label className={tw('flex flex-col gap-1')}>
                ...
                <span className={tw('text-label-small opacity-70')}>
                  Kód jazyka, např. <strong>cs</strong> (čeština),{' '}
                  <strong>en</strong> (angličtina). Aktuálně: {languageHint}.
                </span>
              </label>
