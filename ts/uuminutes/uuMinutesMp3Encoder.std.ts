...
type UuMinutesEncoderWorkletMessage = Readonly<
  | {
      type: 'chunk';
      ...
      this.port.postMessage(
        {
          ...
          lametagFrame,
          finalFrame: chunk,
        } satisfies UuMinutesEncoderWorkletMessage,
...
registerProcessor('uuminutes-mp3-encoder', UuMinutesMp3Encoder);
