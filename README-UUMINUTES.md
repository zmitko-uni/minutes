...
Signal UX and login are unchanged. Minutes extensions live in `ts/uuminutes/` with minimal hooks in upstream files.
...
Detailní popis: **[images/uuminutes/prirucka.md](images/uuminutes/prirucka.md)**  
...
| Whisper models | `%APPDATA%\uuMinutes-uuminutes\uuMinutes\whisper-models\` |

Menu: **Minutes → Open Call Recordings / Open Chat Summaries / AI Settings… / Příručka…**

Uživatelská příručka (součást aplikace): `images/uuminutes/prirucka.md` — udržujte synchronní s novými funkcemi.
...
app/uuminutes_channel.main.ts      # IPC: save files, loopback
...
Viz **[CONTRIBUTING-UUMINUTES.md](CONTRIBUTING-UUMINUTES.md)**.
